#Forked from  https://github.com/spring-guides/gs-spring-boot-docker.git 
...
To build the image you can use some tooling for Maven or Gradle from the community (big thanks to https://github.com/Transmode/gradle-docker[Transmode] and https://github.com/spotify/dockerfile-maven[Spotify] for making those tools available).
